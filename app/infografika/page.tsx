...
export default function InfografikaPage() {
  return (
    <div className="relative mx-auto w-full max-w-7xl px-4 py-10 sm:px-6 lg:px-8">
      <div className="mb-6">
        <h1 className="text-2xl sm:text-3xl font-black tracking-tight text-slate-900">Infografika</h1>
        <p className="mt-2 text-sm text-slate-600">Infografika generatori bo‘limi.</p>
      </div>
      ...
      <div className="relative overflow-hidden rounded-3xl border border-slate-200 bg-white shadow-sm">
        ...
        <div className="absolute inset-0 grid place-items-center p-6">
          <div className="w-full max-w-lg rounded-3xl border border-slate-200 bg-white/80 p-8 text-center shadow-lg backdrop-blur">
            <p className="text-3xl font-black tracking-tight text-slate-900">Tez kunda</p>
            <p className="mt-2 text-sm text-slate-600">
              Bu bo‘lim ustida ishlayapmiz. Tez orada ishga tushadi.
            </p>
          </div>
        </div>
      </div>
